...
def test_calculator_pages_exist():
    ...
    # +refinance-calculator (36) — Phase 5C 2026-05-25 (49,500 vol, KD 40), closes Phase 5.
    assert len(CALC_PAGES) == 36, f"Expected 36 calculator pages, found {len(CALC_PAGES)}"
